...
- Remember that the treatment effect $\delta_i$ refers to the *same* individual!

### Recap:

- The effect of the activity (treatment effect) on person $i$ is the difference between the two potential outcomes
...
```{r fig.align="left", fig.height=4, fig.width=4.5}
include_graphics("Three body Newton.png")
```


![](three body lines.png){.absolute bottom=10 right=100 height="300" width="200"}

![](three body celestial.png){.absolute top=100 right=10 height="200" width="300"}
