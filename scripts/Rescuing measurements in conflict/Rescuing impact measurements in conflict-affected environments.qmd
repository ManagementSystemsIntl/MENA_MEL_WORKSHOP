...
knitr::opts_chunk$set(autodep=T, echo=T, message=F, warning=F, cache=T, error=T, fig.height=4, fig.width=6)
...
### Generalizing d-i-d to multiple periods or groups
...
include_graphics("Baker fig two timings.png")
```
...
```{r echo=F}
include_graphics("Baker panel a.png")
```

------------------------------------------------------------------------

```{r, echo=F}
include_graphics("Baker panel b.png")
```

------------------------------------------------------------------------

```{r, echo=F}
include_graphics("Baker panel c.png")
```

------------------------------------------------------------------------

```{r, echo=F}
include_graphics("Baker panel d.png")
```
...
```{r, echo=F}
include_graphics("g-b fig 3 trend break.png")
```
...
|______|_____________________|__________________|_______________________________|
|  1   |         355         |        0         |               0               |
|  2   |         341         |        14        |              14               |
|  3   |         322         |        19        |              33               |
|  4   |         302         |        20        |              53               |
