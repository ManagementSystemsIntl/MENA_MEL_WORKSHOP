...
-   Recognize the most common algorithms and how they are applied in development settings
...
-   Dimension reduction
    -   Principal Component Analysis, Factor Analysis, Item Response Theory
...
-   Expectation maximization: Iteratively updates probabilities using Bayes' Rule
...
-   Getting under the hood of algorithms
